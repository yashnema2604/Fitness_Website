/*! For license information please see main.7c9c5b14.js.LICENSE.txt */
!(function () {
  var e = {
      228: function (e) {
  ...
  (n.n = function (e) {
    ...
    (function () {
      ...
      var ki =
          ...
          "data-styled",
        Ei = "undefined" != typeof window && "HTMLElement" in window,
        Ci = Boolean(
      ...
      var Pi = (function () {
        ...
        zi = function (e) {
          ...
          for (; Ti.has(Oi); ) Oi++;
          var t = Oi++;
          return Ri.set(e, t), Ti.set(t, e), t;
        },
        Mi = function (e) {
          return Ti.get(e);
        },
        Ii = function (e, t) {
          t >= Oi && (Oi = t + 1), Ri.set(e, t), Ti.set(t, e);
        },
        Ni = "style[" + ki + '][data-styled-version="5.3.5"]',
        ji = new RegExp(
          "^" + ki + '\\.g(\\d+)\\[id="([\\w\\d-]+)"\\].*?"([^"]*)'
        ),
        Li = function (e, t, n) {
            ...
            if (i) {
              ...
              if (l) {
                var u = 0 | parseInt(l[1], 10),
                  s = l[2];
                0 !== u &&
                  (Ii(s, u), Li(e, s, l[3]), e.getTag().insertRules(u, r)),
                  (r.length = 0);
              } else r.push(i);
            }
          }
          ...
          var t = document.head,
            ...
            o = (function (e) {
              for (var t = e.childNodes, n = t.length; n >= 0; n--) {
                var r = t[n];
                if (r && 1 === r.nodeType && r.hasAttribute(ki)) return r;
              }
            })(n),
            a = void 0 !== o ? o.nextSibling : null;
          r.setAttribute(ki, "active"),
        ...
        Vi = Ei,
        Hi = { isServer: !Ei, useCSSOMInjection: !Ci },
        Ki = (function () {
          function e(e, t, n) {
            void 0 === e && (e = bi),
              void 0 === t && (t = {}),
              (this.options = mi({}, Hi, {}, e)),
              (this.gs = t),
              ...
              !this.server &&
                ...
                (function (e) {
                  for (
                    var t = document.querySelectorAll(Ni), n = 0, r = t.length;
                    n < r;
                    n++
                  ) {
                    var o = t[n];
                    o &&
                      "active" !== o.getAttribute(ki) &&
                      (Fi(e, o), o.parentNode && o.parentNode.removeChild(o));
                  }
                })(this));
          }
            ...
            (t.getTag = function () {
              return (
                ...
                (this.tag =
                  ...
                  (o = t.target),
                  (e = n ? new Ui(o) : r ? new Bi(o) : new Wi(o)),
                  new Pi(e)))
              );
              var e, t, n, r, o;
            }),
      ...
      function Xi(e) {
        var t,
          n = "";
        for (t = Math.abs(e); t > 52; t = (t / 52) | 0) n = qi(t % 52) + n;
        return (qi(t % 52) + n).replace(Yi, "$1-$2");
      }
      var Qi = function (e, t) {
      ...
      var Zi = Gi("5.3.5"),
        $i = (function () {
          function e(e, t, n) {
            (this.rules = e),
              (this.staticRulesId = ""),
              (this.isStatic = (void 0 === n || n.isStatic) && Ji(e)),
              (this.componentId = t),
              (this.baseHash = Qi(Zi, t)),
              (this.baseStyle = n),
              Ki.registerId(t);
          }
          return (
            (e.prototype.generateAndInjectStyles = function (e, t, n) {
              ...
              if (
                ...
                if (this.staticRulesId && t.hasNameForId(r, this.staticRulesId))
                  ...
                  var a = gl(this.rules, e, t, n).join(""),
                    i = Xi(Qi(this.baseHash, a) >>> 0);
      ...
      function nl(e) {
        var t,
          ...
          p = function (e, r, a) {
            return (0 === r && -1 !== tl.indexOf(a[n.length])) || a.match(o)
              ? e
              : "." + t;
          };
        function h(e, a, i, l) {
        ...
        return (
          ...
          (h.hash = s.length
            ? s
                .reduce(function (e, t) {
                  return t.name || Ai(15), Qi(e, t.name);
                }, 5381)
                .toString()
            : ""),
          h
      ...
      var rl = t.createContext(),
        ol = (rl.Consumer, t.createContext()),
        al = (ol.Consumer, new Ki()),
        il = nl();
      function ll() {
        return (0, t.useContext)(rl) || al;
      }
      function ul() {
      ...
      function sl(e) {
        ...
        return (
          (0, t.useEffect)(
            function () {
              pi()(r, e.stylisPlugins) || o(e.stylisPlugins);
            },
            [e.stylisPlugins]
          ),
          t.createElement(
            rl.Provider,
            { value: i },
            t.createElement(ol.Provider, { value: l }, e.children)
          )
        );
      }
      var cl = (function () {
          ...
          return (
            (e.prototype.getName = function (e) {
              return void 0 === e && (e = il), this.name + e.hash;
            }),
            e
          );
        })(),
      ...
      function ml(e) {
        return dl.test(e) ? e.replace(fl, hl).replace(pl, "-ms-") : e;
      }
      var vl = function (e) {
        return null == e || !1 === e || "" === e;
      };
        ...
        return vl(e)
          ...
          ? (function e(t, n) {
              ...
              for (var i in t)
                t.hasOwnProperty(i) &&
                  !vl(t[i]) &&
                  ((Array.isArray(t[i]) && t[i].isCss) || xi(t[i])
                    ? a.push(ml(i) + ":", t[i], ";")
                    : gi(t[i])
      ...
      var xl = function (e, t, n) {
        ...
        Sl = /(^-|-$)/g;
      function kl(e) {
        return e.replace(wl, "-").replace(Sl, "");
      }
      var El = function (e) {
        return Xi(Gi(e) >>> 0);
      };
      ...
      function Tl(e) {
        ...
        for (var o = 0, a = n; o < a.length; o++) {
          var i = a[o];
          if (Al(i)) for (var l in i) Pl(l) && Rl(e, i[l], l);
        }
        return e;
      }
      ...
      function Ml(e, n, r) {
        var o = Si(e),
          ...
          s =
            void 0 === u
              ? (function (e, t) {
                  var n = "string" != typeof e ? "sc" : kl(e);
                  zl[n] = (zl[n] || 0) + 1;
                  var r = n + "-" + El("5.3.5" + n + zl[n]);
                  return t ? t + "-" + r : r;
          ...
          d =
            void 0 === c
              ? (function (e) {
                  return Cl(e) ? "styled." + e : "Styled(" + wi(e) + ")";
                })(e)
              : c,
          f =
            n.displayName && n.componentId
              ? kl(n.displayName) + "-" + n.componentId
              : n.componentId || s,
          p =
            o && e.attrs
        ...
        o &&
          ...
          (h = n.shouldForwardProp
            ...
            : e.shouldForwardProp);
        var m,
          v = new $i(r, f, o ? e.componentStyle : void 0),
          ...
          y = function (e, n) {
            return (function (e, n, r, o) {
              var a = e.attrs,
                ...
                })(xl(n, (0, t.useContext)(Ol), l) || bi, n, a),
                p = f[0],
                h = f[1],
                m = (function (e, t, n, r) {
                  var o = ll(),
                    a = ul();
                  return t
                    ? e.generateAndInjectStyles(bi, o, a)
        ...
        return (
          ...
          (m.withComponent = function (e) {
            var t = n.componentId,
              ...
              a = t && t + "-" + (Cl(e) ? e : kl(wi(e)));
            return Ml(e, mi({}, o, { attrs: p, componentId: a }), r);
          }),
          Object.defineProperty(m, "defaultProps", {
            ...
            set: function (t) {
              this._foldedDefaultProps = o ? Tl({}, e.defaultProps, t) : t;
            },
          }),
          (m.toString = function () {
      ...
      var Il = function (e) {
        return (function e(t, n, r) {
          if ((void 0 === r && (r = bi), !(0, di.isValidElementType)(n)))
            return Ai(1, String(n));
          var o = function () {
            return t(n, r, bl.apply(void 0, arguments));
          };
          return (
      ...
      !(function () {
        function e(e, t) {
          (this.rules = e),
            (this.componentId = t),
            (this.isStatic = Ji(e)),
            Ki.registerId(this.componentId + 1);
        }
        var t = e.prototype;
        (t.createStyles = function (e, t, n, r) {
          var o = r(gl(this.rules, t, n, r).join(""), ""),
          ...
          (t.renderStyles = function (e, t, n, r) {
            e > 2 && Ki.registerId(this.componentId + e),
      ...
      function Nl(e) {
        for (
          ...
          n[r - 1] = arguments[r];
        var o = bl.apply(void 0, [e].concat(n)).join(""),
          a = El(o);
        return new cl(a, o);
      }
      !(function () {
        function e() {
          ...
          (this._emitSheetCSS = function () {
            ...
            (this.getStyleTags = function () {
              return e.sealed ? Ai(2) : e._emitSheetCSS();
            }),
            (this.getStyleElement = function () {
              var n;
              if (e.sealed) return Ai(2);
              var r =
                  (((n = {})[ki] = ""),
              ...
              return (
                o && (r.nonce = o),
                [t.createElement("style", mi({}, r, { key: "sc-0-0" }))]
              );
            }),
            (this.seal = function () {
              e.sealed = !0;
            }),
            (this.instance = new Ki({ isServer: !0 })),
            (this.sealed = !1);
        }
        var n = e.prototype;
        (n.collectStyles = function (e) {
          return this.sealed
            ? Ai(2)
            : t.createElement(sl, { sheet: this.instance }, e);
        }),
        ...
        Ul = function (e) {
          ...
          return t.createElement(
            "svg",
            {
              ...
              width: "".concat(a),
              height: "".concat(0.5 * Number(a)),
              viewBox: "0 0 ".concat(a, " ").concat(Number(100)),
      ...
      var eu = function () {
          return (0, yr.jsx)(Do, {
            ...
            alignItems: "center",
            width: "100%",
            children: (0, yr.jsx)(Ul, { color: "grey" }),
          });
        },
        tu = function (e) {
          var t,
        ...
        ou = n.p + "static/media/gym.6e701417c428e2fbc267.png",
        au = function (e) {
          var t = e.item,
            n = e.setBodyPart,
            r = e.bodyPart;
        ...
        iu = function () {
          var e = (0, t.useContext)(nu.VisibilityContext).scrollPrev;
          return (0, yr.jsx)(Jo, {
            onClick: function () {
              return e();
            },
        ...
        lu = function () {
          var e = (0, t.useContext)(nu.VisibilityContext).scrollNext;
          return (0, yr.jsx)(Jo, {
            onClick: function () {
              return e();
            },
        ...
        uu = function (e) {
          var t = e.data,
            ...
            r = e.setBodyPart,
            o = e.bodyPart;
          return (0, yr.jsx)(nu.ScrollMenu, {
            LeftArrow: iu,
            RightArrow: lu,
            children: t.map(function (e) {
              return (0,
              yr.jsx)(io, { itemId: e.id || e, title: e.id || e, m: "0 40px", children: n ? (0, yr.jsx)(au, { item: e, setBodyPart: r, bodyPart: o }) : (0, yr.jsx)(ru, { exercise: e }) }, e.id || e);
            }),
          });
        },
        su = function (e) {
            ...
            n
              ? (0, yr.jsxs)(io, {
                  ...
                  children: [
                    ...
                    (0, yr.jsx)(tu, { exerciseVideos: a, name: n.name }),
                    (0, yr.jsx)(su, {
      ...
      var yu = [
        ...
        xu = t.forwardRef(function (e, t) {
          ...
          return (0,
          yr.jsxs)(bu, u({ as: s, className: J(w.root, o), ownerState: b, focusable: "false", color: f, "aria-hidden": !m || void 0, role: m ? "img" : void 0, ref: t }, x, y, { children: [r, m ? (0, yr.jsx)("title", { children: m }) : null] }));
        });
      xu.muiName = "SvgIcon";
      var wu = xu;
      function Su(e, n) {
        ...
        return (r.muiName = wu.muiName), t.memo(t.forwardRef(r));
      }
      var ku = Su(
          (0, yr.jsx)("path", {
        ...
        Mu = t.forwardRef(function (e, t) {
          var n = No({ props: e, name: "MuiPaginationItem" }),
            ...
            s =
              void 0 === l
                ? { first: ku, last: Eu, next: Au, previous: Cu }
                : l,
            c = n.disabled,
            d = void 0 !== c && c,
            f = n.page,
      ...
      var _u = t.forwardRef(function (e, t) {
          var n = No({ props: e, name: "MuiPagination" }),
            ...
            F = (function () {
              var e =
                ...
                C = Q(e, pu),
                A = l(
                  fu({ controlled: y, default: c, name: o, state: "page" }),
                  2
                ),
                P = A[0],
                R = A[1],
            ...
            B = (function (e) {
              var t = e.classes;
              return Bo({ root: ["root", e.variant], ul: ["ul"] }, du, t);
            })(D);
          return (0, yr.jsx)(
            ju,
            u(
                ...
                children: [
                  ...
                  (0, yr.jsx)(Do, {
                    ...
                    children: f.map(function (e, t) {
                      return (0, yr.jsx)(ru, { exercise: e }, t);
                    }),
                  }),
                  (0, yr.jsx)(Do, {
      ...
      function Ku(e) {
        return Hu(e).defaultView || window;
      }
      function Yu(e) {
        var t,
          n =
      ...
      var qu = ["onChange", "maxRows", "minRows", "style", "value"];
      function Xu(e, t) {
              ...
              function () {
                ...
                if ("0px" !== n.width) {
                  ...
                  var a = n["box-sizing"],
                    ...
                    u =
                      Xu(n, "border-bottom-width") + Xu(n, "border-top-width"),
                    s = r.scrollHeight;
                  r.value = "x";
      ...
      var es = t.createContext();
      function ts() {
        return t.useContext(es);
      }
      var ns = ta;
      function rs(e) {
        var t = e.styles,
      ...
      var os = function (e) {
        return (0, yr.jsx)(rs, u({}, e, { defaultTheme: Po }));
      };
      function as(e) {
      ...
      function is(e) {
        ...
        return (
          e &&
          ((as(e.value) && "" !== e.value) ||
            (t && as(e.defaultValue) && "" !== e.defaultValue))
        );
      }
      function ls(e) {
        return Vo("MuiInputBase", e);
      }
      var us = Ho("MuiInputBase", [
          "root",
          "formControl",
          "focused",
          "disabled",
        ...
        ps = zo("input", {
          ...
          return u(
            (Mt(
              ...
              "label[data-shrink=false] + .".concat(us.formControl, " &"),
              {
              ...
              children: [
                ...
                (0, yr.jsxs)(
                  ...
                  u(
                    {},
                    he,
                    !Zu(pe) && { ownerState: u({}, de, he.ownerState) },
                    {
                      ref: n,
                      onClick: function (e) {
                        X.current &&
      ...
      var ys = u({}, us, Ho("MuiInput", ["root", "underline", "input"])),
        bs = [
          "disableUnderline",
          "components",
          "componentsProps",
        ...
        xs = zo(fs, {
          ...
          return u(
            ...
            !r.disableUnderline &&
              ...
              Mt(t, "&:hover:not(.".concat(ys.disabled, "):before"), {
                borderBottom: "2px solid ".concat(n.palette.text.primary),
                "@media (hover: none)": {
                  borderBottom: "1px solid ".concat(o),
                },
              }),
              Mt(t, "&.".concat(ys.disabled, ":before"), {
                borderBottomStyle: "dotted",
              }),
              t)
          );
        }),
        ws = zo(ps, { name: "MuiInput", slot: "Input", overridesResolver: ds })(
          {}
        ),
        Ss = t.forwardRef(function (e, t) {
          var n = No({ props: e, name: "MuiInput" }),
            ...
            b = i ? Nt(i, y) : y;
          return (0,
          yr.jsx)(vs, u({ components: u({ Root: xs, Input: ws }, a), componentsProps: b, fullWidth: s, inputComponent: d, multiline: p, ref: t, type: m }, v, { classes: g }));
        });
      Ss.muiName = "Input";
      var ks = Ss;
      function Es(e) {
      ...
      var Cs = u({}, us, Ho("MuiFilledInput", ["root", "underline", "input"])),
        As = [
          "disableUnderline",
          "components",
          "componentsProps",
          ...
          return u(
            ...
            !o.disableUnderline &&
              (Mt(
                ...
                "&.".concat(Cs.focused, ":after"),
                { transform: "scaleX(1)" }
              ),
              Mt(n, "&.".concat(Cs.error, ":after"), {
              ...
              Mt(n, "&:hover:not(.".concat(Cs.disabled, "):before"), {
                borderBottom: "1px solid ".concat(r.palette.text.primary),
              }),
              Mt(n, "&.".concat(Cs.disabled, ":before"), {
                borderBottomStyle: "dotted",
              }),
              n),
        ...
        Ts = t.forwardRef(function (e, t) {
          var n = No({ props: e, name: "MuiFilledInput" }),
            ...
            b = a ? Nt(a, y) : y;
          return (0,
          yr.jsx)(vs, u({ components: u({ Root: Ps, Input: Rs }, o), componentsProps: b, fullWidth: l, inputComponent: c, multiline: f, ref: t, type: h }, m, { classes: g }));
        });
      Ts.muiName = "Input";
      var Os,
        zs = Ts,
        Ms = ["children", "classes", "className", "label", "notched"],
        Is = zo("fieldset")({
          textAlign: "left",
          position: "absolute",
          bottom: 0,
      ...
      var Ls = u(
        ...
        _s = zo(fs, {
          ...
          return u(
            (Mt(
              ...
              "&:hover .".concat(Ls.notchedOutline),
              { borderColor: n.palette.text.primary }
            ),
            Mt(
              t,
              "@media (hover: none)",
              Mt({}, "&:hover .".concat(Ls.notchedOutline), { borderColor: o })
            ),
            Mt(t, "&.".concat(Ls.focused, " .").concat(Ls.notchedOutline), {
              borderColor: n.palette[r.color].main,
              borderWidth: 2,
            }),
            Mt(t, "&.".concat(Ls.error, " .").concat(Ls.notchedOutline), {
              borderColor: n.palette.error.main,
            }),
            Mt(t, "&.".concat(Ls.disabled, " .").concat(Ls.notchedOutline), {
        ...
        Ws = t.forwardRef(function (e, n) {
          var r,
            ...
            x = $u({ props: o, muiFormControl: ts(), states: ["required"] });
          return (0, yr.jsx)(
            vs,
            u(
              {
                components: u({ Root: _s, Input: Bs }, i),
      ...
      var Hs = Ho("MuiFormLabel", [
        ...
        Ys = zo("label", {
          ...
          return u(
            ...
            Mt(t, "&.".concat(Hs.disabled), { color: n.palette.text.disabled }),
            Mt(t, "&.".concat(Hs.error), { color: n.palette.error.main }),
            t)
          );
        }),
        qs = zo("span", {
          ...
          var t = e.theme;
          return Mt({}, "&.".concat(Hs.error), { color: t.palette.error.main });
        }),
        Xs = t.forwardRef(function (e, t) {
          ...
          return (0,
          yr.jsxs)(Ys, u({ as: i, ownerState: c, className: J(d.root, o), ref: t }, l, { children: [r, s.required && (0, yr.jsxs)(qs, { ownerState: c, "aria-hidden": !0, className: d.asterisk, children: ["\u2009", "*"] })] }));
        }),
        Qs = Xs;
      function Gs(e) {
      ...
      var Js = ["disableAnimation", "margin", "shrink", "variant"],
        Zs = zo(Qs, {
          shouldForwardProp: function (e) {
            return Ro(e) || "classes" === e;
          },
          ...
          overridesResolver: function (e, t) {
            var n = e.ownerState;
            return [
              Mt({}, "& .".concat(Hs.asterisk), t.asterisk),
              t.root,
              n.formControl && t.formControl,
              "small" === n.size && t.sizeSmall,
              n.shrink && t.shrink,
        ...
        $s = t.forwardRef(function (e, t) {
          ...
          return (0,
          yr.jsx)(Zs, u({ "data-shrink": s, ownerState: d, ref: t }, i, { classes: f }));
        });
      var ec = function (e, n) {
      ...
      var nc = [
        ...
        oc = t.forwardRef(function (e, n) {
                ...
                return (
                  o &&
                    t.Children.forEach(o, function (t) {
                      if (ec(t, ["Input", "Select"])) {
                        var n = ec(t, ["Select"]) ? t.props.input : t;
            ...
            j = l(
              t.useState(function () {
                ...
                return (
                  o &&
                    t.Children.forEach(o, function (t) {
                      ec(t, ["Input", "Select"]) && is(t.props, !0) && (e = !0);
                    }),
                  e
                );
              }),
          ...
          return (0,
          yr.jsx)(es.Provider, { value: V, children: (0, yr.jsx)(rc, u({ as: d, ownerState: O, className: J(z.root, a), ref: n }, T, { children: o })) });
        }),
        ac = oc;
      function ic(e) {
      ...
      var lc,
        ...
        cc = zo("p", {
          ...
          return u(
            ...
            Mt(t, "&.".concat(uc.error), { color: n.palette.error.main }),
            t),
            "small" === r.size && { marginTop: 4 },
            r.contained && { marginLeft: 14, marginRight: 14 }
          );
        }),
        dc = t.forwardRef(function (e, t) {
          ...
          return (0,
          yr.jsx)(cc, u({ as: i, ownerState: c, className: J(d.root, o), ref: t }, l, { children: " " === r ? lc || (lc = (0, yr.jsx)("span", { className: "notranslate", children: "\u200b" })) : r }));
        }),
        fc = (n(457), Hu);
      var pc = t.createContext({});
      function hc(e) {
        return Vo("MuiList", e);
      }
      ...
      var mc = [
        ...
        gc = t.forwardRef(function (e, n) {
          ...
          return (0,
          yr.jsx)(pc.Provider, { value: m, children: (0, yr.jsxs)(vc, u({ as: l, className: J(g.root, a), ref: n, ownerState: v }, h, { children: [p, o] })) });
        });
      function yc(e) {
      ...
      function Ec(e, t, n, r, o, a) {
        for (var i = !1, l = o(e, t, !!t && n); l; ) {
          ...
          if (l.hasAttribute("tabindex") && kc(l, a) && !u)
            return l.focus(), !0;
          l = o(e, l, n);
        }
        return !1;
          ...
          u(
            {
              ...
              onKeyDown: function (e) {
                var t = b.current,
                  n = e.key,
                  r = fc(t).activeElement;
                if ("ArrowDown" === n) e.preventDefault(), Ec(t, r, h, f, wc);
                else if ("ArrowUp" === n)
                  e.preventDefault(), Ec(t, r, h, f, Sc);
                else if ("Home" === n)
                  e.preventDefault(), Ec(t, null, h, f, wc);
                else if ("End" === n) e.preventDefault(), Ec(t, null, h, f, Sc);
                else if (1 === n.length) {
                  var o = x.current,
                    a = n.toLowerCase(),
                    i = performance.now();
                  o.keys.length > 0 &&
                    ...
                    (o.lastTime = i),
                    o.keys.push(a);
                  var l = r && !o.repeating && kc(r, o);
                  o.previousKeyMatched && (l || Ec(t, r, !1, f, wc, o))
                    ? e.preventDefault()
      ...
      var Pc = ["className", "component", "elevation", "square", "variant"],
        Rc = function (e) {
          return (
        ...
        Oc = t.forwardRef(function (e, t) {
          ...
          return (0,
          yr.jsx)(Tc, u({ as: a, ownerState: h, className: J(m.root, r), ref: t }, p));
        }),
        zc = Yu,
        Mc = Ku,
        Ic = n(164),
        ...
        Bc = (function (e) {
          function n(t, n) {
            ...
            return (
              ...
              t.in
                ? a
                  ? ((o = Lc), (r.appearStatus = Fc))
                  : (o = _c)
                : (o = t.unmountOnExit || t.mountOnEnter ? jc : Lc),
              (r.state = { status: o }),
              (r.nextCallback = null),
              r
            );
          ...
          ma(n, e),
            (n.getDerivedStateFromProps = function (e, t) {
              return e.in && t.status === jc ? { status: Lc } : null;
            });
          var r = n.prototype;
          return (
            (r.componentDidMount = function () {
            ...
            (r.updateStatus = function (e, t) {
              void 0 === e && (e = !1),
                null !== t
                  ? (this.cancelNextCallback(),
                    t === Fc ? this.performEnter(e) : this.performExit())
                  : this.props.unmountOnExit &&
                    this.state.status === Lc &&
                    this.setState({ status: jc });
            }),
            (r.performEnter = function (e) {
              var t = this,
                n = this.props.enter,
                r = this.context ? this.context.isMounting : e,
                o = this.props.nodeRef ? [r] : [Ic.findDOMNode(this), r],
                a = o[0],
                i = o[1],
                l = this.getTimeouts(),
                  ...
                  this.safeSetState({ status: Fc }, function () {
                    t.props.onEntering(a, i),
                      t.onTransitionEnd(u, function () {
                        t.safeSetState({ status: _c }, function () {
            ...
            (r.performExit = function () {
              var e = this,
                t = this.props.exit,
                n = this.getTimeouts(),
                r = this.props.nodeRef ? void 0 : Ic.findDOMNode(this);
              t && !Nc
                ? (this.props.onExit(r),
                  this.safeSetState({ status: Dc }, function () {
                    e.props.onExiting(r),
                      e.onTransitionEnd(n.exit, function () {
                        e.safeSetState({ status: Lc }, function () {
                          e.props.onExited(r);
                        });
                      });
                  }))
      ...
      var qc = {
          entering: { opacity: 1, transform: Yc(1) },
        ...
        Qc = t.forwardRef(function (e, n) {
          var r = e.addEndListener,
            ...
            O = R(function (e, t) {
              Vc(e);
              var n,
                r = Hc({ style: v, timeout: y, easing: l }, { mode: "enter" }),
                o = r.duration,
                a = r.delay,
                i = r.easing;
              "auto" === y
            ...
            I = R(function (e) {
              var t,
                n = Hc({ style: v, timeout: y, easing: l }, { mode: "exit" }),
                r = n.duration,
                o = n.delay,
                a = n.easing;
              "auto" === y
                ...
                (e.style.transition = [
                  ...
                  E.transitions.create("transform", {
                    duration: Xc ? t : 0.666 * t,
                    delay: Xc ? o : o || 0.333 * t,
                    easing: a,
                  }),
                ].join(",")),
                (e.style.opacity = 0),
                (e.style.transform = Yc(0.75)),
                p && p(e);
            }),
            N = R(h);
          return (
      ...
      function td(e) {
        return parseInt(Ku(e).getComputedStyle(e).paddingRight, 10) || 0;
      }
      function nd(e, t, n) {
        var r =
        ...
        [].forEach.call(e.children, function (e) {
          -1 === a.indexOf(e) && -1 === i.indexOf(e.tagName) && ed(e, o);
        });
      }
      function rd(e, t) {
        var n = -1;
        ...
        if (!t.disableScrollLock) {
          if (
            (function (e) {
              var t = Hu(e);
              return t.body === e
                ? Ku(e).innerWidth > t.documentElement.clientWidth
            ...
            n.push({
              ...
              (r.style.paddingRight = "".concat(td(r) + o, "px"));
            var a = Hu(r).querySelectorAll(".mui-fixed");
            [].forEach.call(a, function (e) {
              n.push({
                ...
                (e.style.paddingRight = "".concat(td(e) + o, "px"));
            });
          }
            ...
            (n = [
              {
                ...
                value: function (e, t) {
                  ...
                  nd(t, e.mount, e.modalRef, r, !0);
                  var o = rd(this.containers, function (e) {
              ...
              },
              {
                key: "mount",
                value: function (e, t) {
                  var n = rd(this.containers, function (t) {
                      return -1 !== t.modals.indexOf(e);
                    }),
                    r = this.containers[n];
                  r.restore || (r.restore = od(r, t));
                },
              },
              {
                key: "remove",
      ...
      function ld(e) {
        var t = [],
          n = [];
        return (
          Array.from(e.querySelectorAll(id)).forEach(function (e, r) {
            var o = (function (e) {
      ...
      var fd = new ad(),
        pd = t.forwardRef(function (e, n) {
          var r = e.BackdropComponent,
            ...
            ae = na(function (e) {
              (G.current = e), e && (B && oe() ? ne() : ed(Z.current, !0));
            }),
            ie = t.useCallback(
              function () {
                L.remove(te());
          ...
          var le = u({}, e, {
            ...
            ue = (function (e) {
              var t = e.open,
                n = e.exited;
              return Bo({ root: ["root", !t && n && "hidden"] }, cd, e.classes);
            })(le);
          if (!N && !B && (!ee || Y)) return null;
          var se = {};
          void 0 === a.props.tabIndex && (se.tabIndex = "-1"),
            ee &&
              ((se.onEnter = Jc(function () {
                q(!1), U && U();
              }, a.props.onEnter)),
              (se.onExited = Jc(function () {
                q(!0), V && V(), d && ie();
              }, a.props.onExited)));
          var ce = m.Root || p,
            de = g.root || {};
        ...
        vd = { entering: { opacity: 1 }, entered: { opacity: 1 } },
        gd = t.forwardRef(function (e, n) {
          var r = vu(),
            ...
            z = P(g),
            M = P(function (e) {
              var t = Hc({ style: y, timeout: x, easing: c }, { mode: "exit" });
      ...
      var xd = [
        ...
        Sd = t.forwardRef(function (e, t) {
          var n,
            ...
            S = (function (e) {
              var t = e.classes;
              return Bo({ root: ["root", e.invisible && "invisible"] }, bd, t);
            })(w);
          return (0,
          yr.jsx)(b, u({ in: v, timeout: g }, x, { children: (0, yr.jsx)(wd, { "aria-hidden": !0, as: null != (n = c.Root) ? n : l, className: J(S.root, p), ownerState: u({}, w, null == (r = f.root) ? void 0 : r.ownerState), classes: S, ref: t, children: a }) }));
        }),
        kd = [
          "BackdropComponent",
          "closeAfterTransition",
      ...
      var Nd = zo(Ad, {
        ...
        Ld = t.forwardRef(function (e, n) {
          var r = No({ props: e, name: "MuiPopover" }),
            ...
            j = (function (e) {
              return Bo({ root: ["root"], paper: ["paper"] }, Pd, e.classes);
            })(N),
            L = t.useCallback(
              function () {
                ...
                var e = Id(a),
                  t = (
                    e && 1 === e.nodeType ? e : fc(M.current).body
                  ).getBoundingClientRect();
                return {
                  top: t.top + Od(t, l.vertical),
                  left: t.left + zd(t, l.horizontal),
                };
              },
            ...
            F = t.useCallback(
              function (e) {
                return {
                  vertical: Od(e, k.vertical),
                  horizontal: zd(e, k.horizontal),
                };
              },
            ...
            _ = t.useCallback(
              function (e) {
                var t = { width: e.offsetWidth, height: e.offsetHeight },
                  n = F(t);
                if ("none" === d)
                  return { top: null, left: null, transformOrigin: Md(n) };
                var r = L(),
                  o = r.top - n.vertical,
      ...
      var Dd = ["onEntering"],
        ...
        Wd = { vertical: "top", horizontal: "right" },
              ...
              u(
                {
                  ...
                  transformOrigin: A ? Wd : Ud,
                  PaperProps: u({ component: Hd }, m, {
      ...
      var Xd = Ho("MuiNativeSelect", [
        ...
        Qd = ["className", "disabled", "IconComponent", "inputRef", "variant"],
        Gd = function (e) {
          var t,
            n = e.ownerState,
            r = e.theme;
        ...
        Jd = zo("select", {
          ...
          overridesResolver: function (e, t) {
            ...
            return [
              t.select,
              t[n.variant],
              Mt({}, "&.".concat(Xd.multiple), t.multiple),
            ];
          },
        })(Gd),
        Zd = function (e) {
        ...
        ef = t.forwardRef(function (e, n) {
          ...
          return (0,
          yr.jsxs)(t.Fragment, { children: [(0, yr.jsx)(Jd, u({ ownerState: d, className: J(f.select, r), disabled: o, ref: i || n }, c)), e.multiple ? null : (0, yr.jsx)($d, { as: a, ownerState: d, className: f.icon })] });
        }),
        tf = fu;
      function nf(e) {
      ...
      var rf,
        ...
        lf = zo("div", {
          ...
          overridesResolver: function (e, t) {
            var n = e.ownerState;
            return [
              Mt({}, "&.".concat(of.select), t.select),
              Mt({}, "&.".concat(of.select), t[n.variant]),
              Mt({}, "&.".concat(of.multiple), t.multiple),
            ];
          },
        })(
          Gd,
      ...
      var ff,
        ...
        hf = t.forwardRef(function (e, n) {
          var r = e["aria-describedby"],
            ...
            L = Q(e, af),
            F = l(tf({ controlled: I, default: f, name: "Select" }), 2),
            _ = F[0],
            D = F[1],
            B = l(tf({ controlled: P, default: d, name: "Select" }), 2),
            W = B[0],
            U = B[1],
            V = t.useRef(null),
            H = t.useRef(null),
          ...
          t.useImperativeHandle(
            ...
            t.useEffect(
              function () {
                if (g) {
                  var e = fc(H.current).getElementById(g);
                  if (e) {
                    var t = function () {
          ...
          var ce = ae.map(function (e, n, r) {
            ...
            if (x) {
              ...
              (o = _.some(function (t) {
                return cf(t, e.props.value);
              })),
                o && se && ue.push(e.props.children);
            } else (o = cf(_, e.props.value)) && se && (re = e.props.children);
          ...
          return (0, yr.jsxs)(t.Fragment, {
            children: [
              ...
              (0, yr.jsx)(uf, { as: m, className: me.icon, ownerState: he }),
              (0, yr.jsx)(
                Yd,
                u(
                  {
        ...
        mf = hf,
        vf = Su((0, yr.jsx)("path", { d: "M7 10l5 5 5-5z" }), "ArrowDropDown"),
        gf = [
          "autoWidth",
          "children",
          "classes",
        ...
        Sf = t.forwardRef(function (e, n) {
          var r = No({ name: "MuiSelect", props: e }),
            ...
            j = A ? ef : mf,
            L =
              $u({ props: r, muiFormControl: ts(), states: ["variant"] })
                .variant || I,
            F =
              y ||
              {
                standard: ff || (ff = (0, yr.jsx)(bf, {})),
                outlined: (0, yr.jsx)(xf, { label: x }),
                filled: pf || (pf = (0, yr.jsx)(wf, {})),
              }[L],
            _ = (function (e) {
              return e.classes;
      ...
      var Cf = [
        ...
        Af = { standard: ks, filled: zs, outlined: Us },
        Pf = zo(ac, {
          name: "MuiTextField",
          slot: "Root",
          overridesResolver: function (e, t) {
        ...
        Rf = t.forwardRef(function (e, t) {
          var n = No({ props: e, name: "MuiTextField" }),
            ...
            q = (function (e) {
              return Bo({ root: ["root"] }, Ef, e.classes);
            })(Y);
          var X = {};
          "outlined" === H &&
          ...
          return (0,
          yr.jsxs)(Pf, u({ className: J(q.root, l), disabled: p, error: m, fullWidth: y, ref: t, required: L, color: c, variant: H, ownerState: Y }, K, { children: [null != C && "" !== C && (0, yr.jsx)($s, u({ htmlFor: G, id: $ }, w, { children: C })), D ? (0, yr.jsx)(kf, u({ "aria-describedby": Z, id: G, labelId: $, value: U, input: te }, B, { children: i })) : te, b && (0, yr.jsx)(dc, u({ id: Z }, v, { children: b }))] }));
        }),
        Tf = Rf,
        Of = function (e) {
        ...
        zf = n.p + "static/media/banner.5209b5e92a864ca0c615.png",
        Mf = function () {
          return (0, yr.jsxs)(io, {
        ...
        If = function () {
          ...
          return (0, yr.jsxs)(io, {
            children: [
              (0, yr.jsx)(Mf, {}),
              (0, yr.jsx)(Of, { setExercises: r, bodyPart: a, setBodyPart: i }),
              (0, yr.jsx)(Bu, { setExercises: r, exercises: n, bodyPart: a }),
            ],
          });
        },
        Nf = function () {
          ...
          return (0, yr.jsxs)(io, {
            ...
            children: [
              ...
              (0, yr.jsx)(Jo, {
                ...
                textAlign: "center",
                pb: "40px",
                children: "Made with \u2764\ufe0f by JavaScript Mastery",
              }),
            ],
          });
        },
        Lf = function () {
          return (0, yr.jsxs)(io, {
            ...
            children: [
              ...
              (0, yr.jsxs)(U, {
                children: [
                  (0, yr.jsx)(B, { path: "/", element: (0, yr.jsx)(If, {}) }),
                  (0, yr.jsx)(B, {
                    path: "/exercise/:id",
                    element: (0, yr.jsx)(cu, {}),
                  }),
      ...
      o.createRoot(document.getElementById("root")).render(
        (0, yr.jsx)(t.StrictMode, {
          children: (0, yr.jsx)(q, { children: (0, yr.jsx)(Lf, {}) }),
        })
      );
    })();
})();
//# sourceMappingURL=main.7c9c5b14.js.map
